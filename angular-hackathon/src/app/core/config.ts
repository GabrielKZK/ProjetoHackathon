...
export const CAPACIDADE_LITROS = TOTAL_POSICOES * LITROS_POR_PALETE; // 230400
export const CAPACIDADE_GARRAFAS = TOTAL_POSICOES * GARRAFAS_POR_PALETE; // 115200

export const TOTAL_DOCAS = 4;

/** Faixas do semaforo de vencimento */
